    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Cupcoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Cupcoin Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  cupcoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Cupcoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 CUP, 0.1 CUP, 1 CUP and 10 CUP -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://cupcoincoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://cupcoincoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Cupcoin Core is shutting down...") + "<br /><br />" +
