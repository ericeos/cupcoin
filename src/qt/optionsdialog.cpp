    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("CUP-light"), QVariant("light"));
    ui->theme->addItem(QString("CUP-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("CUP-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("CUP-traditional"), QVariant("trad"));
