...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 30 * 2 * 60; // Cupcoin: 1 hour, 30 blocks
        consensus.nPowTargetSpacing = 2 * 60; // Cupcoin: 2 minutes
        ...
        vSeeds.push_back(CDNSSeedData("masterhash.us", "cupcoin1.masterhash.us"));
        vSeeds.push_back(CDNSSeedData("masterhash.us", "cupcoin2.masterhash.us"));
        vSeeds.push_back(CDNSSeedData("masterhash.us", "cupcoin3.masterhash.us"));
        vSeeds.push_back(CDNSSeedData("masterhash.us", "cupcoin4.masterhash.us"));
        vSeeds.push_back(CDNSSeedData("masterhash.us", "cupcoin5.masterhash.us"));
        vSeeds.push_back(CDNSSeedData("masterhash.us", "cupcoin6.masterhash.us"));
        //vSeeds.push_back(CDNSSeedData("shmest.win", "dns.shmest.win"));

        // Cupcoin addresses start with 'C'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,28);
        // Cupcoin script addresses start with 'c'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,88);
        // Cupcoin private keys start with '1'
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,0);
        // Cupcoin BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // Cupcoin BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();
        // Cupcoin BIP44 coin type is '5'
...
public:
    CTestNetParams() {
        ...
        consensus.powLimit = uint256S("00000fffff000000000000000000000000000000000000000000000000000000");
        consensus.nPowTargetTimespan = 60 * 60; // Cupcoin: 1 hour
        consensus.nPowTargetSpacing = 2 * 60; // Cupcoin: 2 minutes
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("cupcoinnodes.space",  "testnet-dns.cupcoinnodes.space"));

        // Testnet Cupcoin addresses start with 'C'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,28);
        // Testnet Cupcoin script addresses start with 'c'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,88);
        // Testnet private keys start with '1'
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,0);
        // Testnet Cupcoin BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet Cupcoin BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();
        // Testnet Cupcoin BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams() {
        ...
        // Regtest Cupcoin addresses start with 'C'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,28);
        // Regtest Cupcoin script addresses start with 'c'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,88);
        // Regtest private keys start with '1'
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,0);
        // Regtest Cupcoin BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Regtest Cupcoin BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();
        // Regtest Cupcoin BIP44 coin type is '1' (All coin's testnet default)
        base58Prefixes[EXT_COIN_TYPE]  = boost::assign::list_of(0x80)(0x00)(0x00)(0x01).convert_to_container<std::vector<unsigned char> >();
   }
};
