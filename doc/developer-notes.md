...
Cupcoin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Cupcoin Core, where everyone uses
...
pay attention to for reviewers of Cupcoin Core code.

General Cupcoin Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Cupcoin Core uses tinyformat, which is type safe. Leave them out to avoid confusion
