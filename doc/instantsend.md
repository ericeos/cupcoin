...
This mechanism has been integrated into Bitcore-Node-Cupcoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/cupcoincoin/insight-api-cupcoin#web-socket-api](https://github.com/cupcoincoin/insight-api-cupcoin#web-socket-api) 
* API: [https://github.com/cupcoincoin/insight-api-cupcoin#instantsend-transactions](https://github.com/cupcoincoin/insight-api-cupcoin#instantsend-transactions) 
...
By default, the Cupcoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Cupcoin Core daemon:
