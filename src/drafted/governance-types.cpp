...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "CupcoinNetwork") type = CupcoinNetwork;
    if(strType == "CupcoinNetworkVariable") type = CupcoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == CupcoinNetwork) s = "CupcoinNetwork";
    if(type == CupcoinNetworkVariable) s = "CupcoinNetworkVariable";
