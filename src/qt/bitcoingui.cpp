    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Cupcoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Cupcoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and cupcoin: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Cupcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Cupcoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Cupcoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Cupcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Cupcoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a cupcoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Cupcoin Core help message to get a list with possible Cupcoin Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Cupcoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Cupcoin network", "", count));
}
...
{
    QString strTitle = tr("Cupcoin Core"); // default title
