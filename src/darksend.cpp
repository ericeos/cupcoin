...
{
    if(fLiteMode) return; // ignore all Cupcoin related functionality
...
/*
    ...
    allow endless transaction that would bloat Cupcoin and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("cupcoin-privatesend");
